...
LIBRARY_NAME = dxkpure

# add your .c source files, one object per file, to the SOURCES
# variable, help files will be included automatically, and for GUI
# objects, the matching .tcl file too
SOURCES = red~.c exprand.c linrand.c scaledeg.c euclid.c grainyrd~.c sawlim~.c sqlim~.c sinbankd~.c sinbankr~.c sinbank~.c randlist.c wesley~.c dxkadsr~.c magikp~.c dxkstut~.c dxkmetrox.c 

# list all pd objects (i.e. myobject.pd) files here, and their helpfiles will
# be included automatically
PDOBJECTS = red~.pd exprand.pd linrand.pd scaledeg.pd euclid.pd grainyrd~.pd sawlim~.pd sqlim~.pd sinbankd~.pd sinbankr~.pd sinbank~.pd randlist.pd wesley~.pd dxkadsr~.pd magikp~.pd dxkstut~.pd dxkmetrox.pd
...
PACKAGE_NAME='dxkpure'
PACKAGE_TARNAME='dxkpure'
PACKAGE_VERSION='0.1'
PACKAGE_STRING='dxkpure 0.1'
