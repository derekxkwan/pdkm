...
SOURCES = red~.c exprand.c linrand.c scaledeg.c euclid.c grainyrd~.c sawlim~.c sqlim~.c 

# list all pd objects (i.e. myobject.pd) files here, and their helpfiles will
# be included automatically
PDOBJECTS = red~.pd exprand.pd linrand.pd scaledeg.pd euclid.pd grainyrd~.pd sawlim~.pd sqlim~.pd
